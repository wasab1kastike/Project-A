...
| Recruit     | Castle              | Queue paid army and process it into the simple castle army pool.                                 |
| Assign      | Army                | Season 5 does not use battalion jobs; fishing and water-body interaction are the main map focus. |
...
- Castle economy creates the workers, recruitment queue, wagon capacity, and upgrade choices that make map plans possible.
...
- War uses map borders, diplomacy state, pressure priorities, travel time, roads, and delayed battlefield resolution where legacy combat remains active.
...
- Castle: economy, recruitment queue, upgrades, owned-tile status, character/cosmetic management.
...
2. Castle economy, recruitment, and Season 5 fishing progression.
