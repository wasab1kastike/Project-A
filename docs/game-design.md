...
- Passive fishing resolves through Cast Reel rounds. Each due cast runs Hook, Fight, and Haul phases from class stats, passives, bait, rhythm, water profile, and pack pressure. Bad rounds can safely miss, but never spend fish coins or damage gear.
- Successful Cast Reel rounds grant catches and XP until inventory, pool stock, or player action stops the session. Returning home unloads the current haul and sells fish for fish coins.
...
- Bait is a consumable stack, not an equipment slot. Bare Hook is the free baseline, while paid bait sets last one hour and cannot be replaced until their timer ends. Bait changes Cast Reel tags such as Hook+, Fight+, Haul+, Jackpot, Safe, and Weird.
