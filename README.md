...
- Season 5 preview is a separate fishing ruleset where every visible lake, river, coast, and sea tile becomes a destination with hidden shared stock, deterministic tile traits, Cast Reel bait-and-time fishing rounds, kilogram fish weights, regeneration, hybrid character equipment art, fish coins, bait sets, rare item hooks, and gated deep, lava, and void profiles
