...
- the Castle Diplomacy tab supports peace offers with optional demands from either side, while trade offers move accepted gold, food, army, score points, and allied tile deeds as six-hour-minimum convoy legs; Trade Wagon building upgrades raise each wagon's gold+food capacity from 100 up to 20,000
