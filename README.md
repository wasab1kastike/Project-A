...
- [Game systems plan](docs/game-systems-plan.md)
...
- the battlefield HUD includes an opt-in ambient sound toggle for generated water, wind, soft pad, and small nature blips; no gameplay information depends on audio
...
- **Zoom:** mouse wheel, trackpad pinch, mobile pinch, or keyboard `+`/`-` while the map is focused
...
- **View actions:** use the compact reset control to return to the default framing, or the focus control to center your fortress
