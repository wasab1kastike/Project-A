  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Fishing grants XP and skill points. Build choices can improve catch speed, rarity, trophy weight, inventory, travel, discovery, or access to risky waters. Fish unloads pay fish coins for the static shop, paid bait lasts one hour, and very rare item hooks unlock equipment instantly. Outfit coats swap the fitted character base, while hats and rods layer on top.",
      },
    ],
  },
  {
