...
const RACE_ABILITY_NOTES: Record<string, readonly string[]> = {
  DWARFS: [
    ...
    "Deep Mining: once every 60 minutes during active season. Commit 150-600 gold, then wait 10/20/30 minutes based on commitment size. Roll table favors gold, food, recruitment bursts, combat surge, army gains/losses, production halts, and partial gold loss. Rune suppression no longer comes from Deep Mining.",
  ...
  UNSTABLE_UNICORNS: [
    ...
    "Tier 2 (6 marsh/forest): Shattered Reality unlocks once per Helsinki day and rolls a random boon: Mirror Host army growth, Prismatic Surge combat power, or Lucky Gallop economy.",
