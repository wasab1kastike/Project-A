...
export const ACTIVE_LOCATION_SHUFFLE_COST_INCREMENT = 1000;

export function getActiveLocationShuffleCost(locationShuffleCount: number) {
  return (locationShuffleCount + 1) * ACTIVE_LOCATION_SHUFFLE_COST_INCREMENT;
}
export const CURRENT_MAP_LAYOUT_VERSION = 5;
export const REGISTRATION_DURATION_HOURS = 24;
export const TESTING_DURATION_HOURS = 24;
export const TESTING_ENDS_BEFORE_ACTIVE_HOURS = 1;
export const ACTIVE_DURATION_HOURS = 24 * 14;
export const ATTACK_UNIT_SPEED_PER_MINUTE = 2.4;
...
export const FORTRESS_LEVEL_UP_COSTS = [
  2000, 6000, 12000, 20000, 30000, 42000, 56000, 72000, 90000,
] as const;
...
export const GOD_EMPEROR_USER_EMAIL = "god-emperor-a@project-a.local";
export const GOD_EMPEROR_CHAT_AUTHOR_NAME = "God Emperor A";
